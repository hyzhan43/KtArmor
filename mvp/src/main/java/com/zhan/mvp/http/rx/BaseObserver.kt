...
open class BaseObserver<R, T : BaseResponse<R>>(val presenter: BasePresenter<*>,
     ...
     *  处理onNext 拦截
     */
    open fun onNextHandle(response: T): Boolean {
        return response.errorCode == Setting.SUCCESS
    }
}